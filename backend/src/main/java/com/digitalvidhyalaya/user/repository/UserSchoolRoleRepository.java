...
public interface UserSchoolRoleRepository extends JpaRepository<UserSchoolRole, Long> {
    ...
    List<UserSchoolRole> findAllBySchool_SchoolIdAndStatus(String schoolId, RecordStatus status);

    List<UserSchoolRole> findAllByUser_IdAndStatus(Long userId, RecordStatus status);
}
